...
Item {
    ...
    function getFileContent(filepath) {
        try {
            ...
            if (verbose) console.log("Could not read file:", filepath)
        }
        return null
    }
    ...
    function checkForChanges() {
        ...
        if (configContent !== null) {
            ...
            if (fileHashes.config === undefined) {
                ...
                if (verbose) console.log("Initial config hash:", configHash)
        ...
        if (themeContent !== null) {
            ...
            if (fileHashes[themeKey] === undefined) {
                ...
                if (verbose) console.log("Initial theme hash for", themeName, ":", themeHash)
    ...
    Component.onCompleted: {
        ...
        if (verbose) console.log("Watching config.json and theme files for changes")
    }
}
